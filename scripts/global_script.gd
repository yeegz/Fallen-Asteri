...
@onready var current_scene = "res://Scenes/beach/scene.tscn"
...
func load():
	...
	health_on_kill = info[20]
	alive_status_third_boss = info[21]
	alive_status_main_boss = info[22]
